...
class BetterFrenchApp {
    ...
    async loadLatestData() {
        try {
            ...
            console.log('Loading AI-enhanced articles with contextual learning...');

            // Load ONLY AI-enhanced articles - every article has contextual learning
    ...
    async getLatestProcessedFile() {
        // Use the current articles file that the system generates
        return './current_articles.json';
    }
